...
- [4. Quality Control](#4-quality-control)
  - [4.1 Flatten Collection](#41-flatten-collection)
  - [4.2 Falco — Per-Sample Quality Assessment](#42-falco--per-sample-quality-assessment)
  - [4.3 MultiQC — Aggregation of Falco Reports](#43-multiqc--aggregation-of-falco-reports)
  - [4.4 Cutadapt — Quality Trimming and Filtering](#44-cutadapt--quality-trimming-and-filtering)
  - [4.5 MultiQC — Aggregation of Cutadapt Reports](#45-multiqc--aggregation-of-cutadapt-reports)
- [5. Mapping](#5-mapping)
  - [5.1 Reference Annotation Import](#51-reference-annotation-import)
  - [5.2 RNA STAR — Spliced Alignment](#52-rna-star--spliced-alignment)
  - [5.3 MultiQC — Aggregation of STAR Logs](#53-multiqc--aggregation-of-star-logs)
- [6. Inspection of Mapping Results](#6-inspection-of-mapping-results)
  - [6.1 IGV — Local Visualization](#61-igv--local-visualization)
  - [6.2 JBrowse2 — Galaxy-Integrated Visualization](#62-jbrowse2--galaxy-integrated-visualization)
- [7. Estimation of Library Strandedness](#7-estimation-of-library-strandedness)
  - [7.1 Visual Inspection — IGV](#71-visual-inspection--igv-chr3r94450009448000)
  - [7.2 Visual Inspection — JBrowse2](#72-visual-inspection--jbrowse2-chr3r94450009448000)
  - [7.3 pyGenomeTracks — Strand-Specific Coverage](#73-pygenometracks--strand-specific-coverage-chr4540000560000)
  - [7.4 STAR Gene Counts — MultiQC Aggregation](#74-star-gene-counts--multiqc-aggregation)
  - [7.5 Infer Experiment — Computational Strandness Inference](#75-infer-experiment--computational-strandness-inference)
- [8. Read Counting — featureCounts](#8-read-counting--featurecounts)
  - [8.1 Reformat STAR Output](#81-reformat-star-output)
  - [8.2 Gene Length Calculation](#82-gene-length-calculation)
- [9. Differential Expression Analysis — DESeq2](#9-differential-expression-analysis--deseq2)
  - [9.1 Data Import](#91-data-import)
  - [9.2 DESeq2 Configuration](#92-deseq2-configuration)
  - [9.3 DESeq2 Outputs](#93-deseq2-outputs)
  - [9.4 Quality Visualizations](#94-quality-visualizations)
